      ...
      <div className="vm__inner">
        <div className="vm__inner__v" id="vision">
          ...
          <div>
            ...
            <div className="vm__inner__subtitle">
              To offer solutions that brings visible, quantifiable and
              verifiable result to our clients first time, every time.
            </div>
          </div>
        </div>
        <div className="vm__inner__v" id="mission">
          <div>
            <div className="vm__inner__title">
              Our Mission: <br />
              <span>Provide</span> business <br /> with the{" "}
              <span>positive</span> <br /> incentives
            </div>
            <div className="vm__inner__subtitle">
              Our mission is to provide business with the positive incentive
              they need to compete responsibly, profitably and deliver value in
              an everevolving business environment.
            </div>
          </div>

          <div className="vm__inner__v__card">
            <Image alt="" width={300} height={251} src={Mission} />
          </div>
        </div>
        ...
        <div className="vm__inner__v" id="values">
          ...
          <div>
            <div className="vm__inner__title">
              Our Values: <br />
              Continuously <span>achieve</span> <br /> <span>superior</span>{" "}
              financial & <br /> operating results
            </div>
            <div className="vm__inner__subtitle">
              ...
              standards. ASMAD Continuously seeks high performance standards;
              maintaining a strong and growing long-term leadership position in
              the ever changing, competitive environments in which we operate.
            </div>
          </div>
        </div>
      </div>
